...
UTEST(ece5210_allpass, linear)
{
    int ret = system("python test_utils/ece5210_allpass_linear.pyc");
...
UTEST(ece5210_allpass, min)
{
    int ret = system("python test_utils/ece5210_allpass_min.pyc");
    char filename_x[] = "x.mtx";
    char filename_y[] = "y.mtx";
    ...
    for (uint16_t i = 0; i < x->size; i++)
    {
        y_my->data[i] = H_min(x->data[i], b_min,
                              NUM_TAPS_FIR);
    }
...
//    printf("y_sol | y_my\n");
//    printf("------+------\n");
//    for (uint16_t i = 0; i < x->size/100; i++)
//    {
//        printf("%-6.3f | %-6.3f\n", y_sol->data[i], y_my->data[i]);
//    }
//
//    double error = mean_absolute_error_f32(y_sol, y_my);
//
...
UTEST(ece5210_allpass, all_pass)
{
    int ret = system("python test_utils/ece5210_allpass_ap.pyc");
    char filename_x[] = "x.mtx";
    char filename_y[] = "y.mtx";
...
//    printf("sample_in | y_sol | y_my\n");
//    printf("------+------\n");
//    for (uint16_t i = 0; i < x->size/100; i++)
//    {
//    	printf("%-6.3f | %-6.3f | %-6.3f\n", x->data[i], y_sol->data[i], y_my->data[i]);
//    }
