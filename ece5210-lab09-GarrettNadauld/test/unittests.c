...
//    for (uint16_t n = 0; n < y_trad->size/100; n++)
//    {
//        // Print y_trad and y_half in the specified format
//        printf("%.6f || %.6f\n", y_trad->data[n], y_half->data[n]);
//    }
...
UTEST(ece5210_fir, fir_least_squares)
{

    int ret = system("python test_utils/ece5210_firls_test.py");
    ASSERT_FALSE(ret);
}
